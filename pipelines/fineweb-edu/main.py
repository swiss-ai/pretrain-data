...
if len(sys.argv) != 2:
    print("The first argument should be the config name: python main.py keeprobots.")
    exit(1)
...
BASE_OUTPUT_DIR = f"./swissai-fineweb-edu-{CONFIG_NAME}/"
...
if __name__ == "__main__":
    ...
    for dump in DUMPS:
        ...
        SlurmPipelineNodeExecutor(
            pipeline=pipeline,
            job_name=f"fwedu-{dump}-{CONFIG_NAME}",
